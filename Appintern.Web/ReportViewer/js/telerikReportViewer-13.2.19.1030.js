...
(function(trv, $, window, document, undefined) {
    ...
    var Scroll = {
        ...
        _updatePageContent: function _updatePageContent(page, renderedPage) {
            ...
            var pageNumber = page.pageNumber, wrapper = $($.parseHTML(page.pageContent)), $pageContent = wrapper.find("div.sheet"), $page = this.$placeholder.find('<div class="trv-report-page" data-page="' + pageNumber + '"></div>');
...
/* DO NOT MODIFY OR DELETE THIS LINE! UPGRADE WIZARD CHECKSUM 622A391125851B16644290706D81294D */