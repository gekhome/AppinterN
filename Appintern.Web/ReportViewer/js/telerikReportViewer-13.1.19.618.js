/*
* TelerikReporting v13.1.19.618 (http://www.telerik.com/products/reporting.aspx)
...
(function(trv, $, window, document, undefined) {
    ...
    function ReportViewer(dom, options) {
        ...
        if (window.kendo) {
            return initViewer(dom, options);
        } else {
            var baseUri = utils.rtrim(svcApiUrl, "\\/") + "/";
            var kendoUrl = baseUri + "resources/js/telerikReportViewer-kendo";
            $.cachedScript(kendoUrl).fail(function(jqxhr, settings, exception) {
        ...
        function initViewer(dom, options) {
...
/* DO NOT MODIFY OR DELETE THIS LINE! UPGRADE WIZARD CHECKSUM 3955FD114BD71D0971B2B5EF0F3ACA18 */